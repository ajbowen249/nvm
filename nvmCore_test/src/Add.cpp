...
INSTANTIATE_TEST_CASE_P(AddUi8,
    ...
    ::testing::Values(
        ...
        AddUi8Params(1, 255, 0, FLAGS(Z)),
        AddUi8Params(15, 255, 14, FLAGS(P))
    )
);
...
INSTANTIATE_TEST_CASE_P(AddI8,
    ...
    ::testing::Values(
        ...
        AddI8Params(127, 1, -128, FLAGS(N)),
        AddI8Params(-128, -1, 127, FLAGS(P))
    )
);
...
INSTANTIATE_TEST_CASE_P(AddUi16,
    ...
    ::testing::Values(
        ...
        AddUi16Params(65535, 1, 0, FLAGS(Z)),
        AddUi16Params(65279, 512, 255, FLAGS(P))
    )
);
...
INSTANTIATE_TEST_CASE_P(AddI16,
    ...
    ::testing::Values(
        ...
        AddI16Params(32767, 1, -32768, FLAGS(N)),
        AddI16Params(-32768, -1, 32767, FLAGS(P))
    )
);
...
INSTANTIATE_TEST_CASE_P(AddUi32,
    ...
    ::testing::Values(
        ...
        AddUi32Params(4294967295, 1, 0, FLAGS(Z)),
        AddUi32Params(4294967039, 512, 255, FLAGS(P))
    )
);
...
INSTANTIATE_TEST_CASE_P(AddI32,
    ...
    ::testing::Values(
        ...
        AddI32Params(2147483647, 1, -2147483648, FLAGS(N)),
        AddI32Params(-2147483648, -1, 2147483647, FLAGS(P))
    )
);
